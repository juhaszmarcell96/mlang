...
public:
    ...
    Value(value_types type) : m_type(type) {
        switch (m_type) {
            ...
            case value_types::vector: { m_value = new Array;  break; }
    ...
    explicit Value (const Array& arr)  { m_value = new Array;  *as_array()  = arr; m_type = value_types::vector;  }
    ...
    Value(const Value& other) {
        ...
        switch (m_type) {
            ...
            case value_types::vector: { m_value = new Array;  *as_array()  = other.get_array();  break; }
            default: { throw bad_value_type{}; }
        }
    }
    ...
    Value& operator=(const Value& rhs) {
        ...
        switch (m_type) {
            ...
            case value_types::vector: { m_value = new Array;  *as_array()  = rhs.get_array();  break; }
            default: { throw bad_value_type{}; }
        }
        return *this;
    }
    ...
    const Array&  get_array  () const { assert_type(m_type, value_types::vector); return *as_array();  }
    ...
    Value& operator++() {
        switch (m_type) {
            ...
            case value_types::vector: { throw bad_operation ("value of type 'array' cannot be incremented"); }
            default: { throw bad_value_type{}; }
        }
    }
    ...
    Value& operator[](std::size_t index) {
        switch (m_type) {
            ...
            case value_types::vector: { return (*as_array())[index]; }
            default: { throw bad_value_type{}; }
        }
    }
    ...
    void append(const Value& var) {
        switch (m_type) {
            ...
            case value_types::vector: { return (*as_array()).push_back(var); }
            default: { throw bad_value_type{}; }
        }
    }
    ...
    void clear() {
        switch (m_type) {
            ...
            case value_types::vector: { as_array()->clear(); break; }
            default: { throw bad_value_type{}; }
        }
    }
    ...
    friend std::ostream &operator<<(std::ostream &os, const Value& var) {
        switch (var.m_type) {
            ...
            case value_types::vector: { for (const Value& v : *(var.as_array())) { os << v << " "; }; break; }
            default: { throw bad_value_type{}; }
        }
        return os;
    }
